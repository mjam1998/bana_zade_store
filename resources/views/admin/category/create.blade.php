        ...
        <div class="profile-section active">
            ...
            <form method="post" action="{{route('admin.category.store')}}" enctype="multipart/form-data" >
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control mt-2" name="slug" value="{{old('slug')}}" placeholder="آدرس دسته بندی در سایت">
                        </div>
                    </div>
                </div>
                ...
                <div class="row mt-3">
                    <div class="col-md-4">
                        <div class="form-group">
                            <label class="control-label required">تصویر دسته بندی</label>
