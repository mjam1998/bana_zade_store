                    ...
                    <div class="card shadow-lg border-0 rounded-4">
                        <div class="card-body p-4 p-sm-5">
                            <div class="text-center mb-4">
                                <h2 class="fw-bold h4">تعیین رمز عبور جدید</h2>
                                <p class="text-muted small mt-2">رمز عبور جدید خود را انتخاب کنید</p>
                            </div>
                            ...
                            <form action="{{ route('password.reset') }}" method="POST">
                                ...
                                <div class="mb-3">
                                    <label class="form-label fw-bold small">رمز عبور جدید</label>
